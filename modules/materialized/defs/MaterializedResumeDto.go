...
type MaterializedResumeDto struct {
...
func (x *MaterializedResumeDto) Json() string {
	if x != nil {
...
func GetMaterializedResumeDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastMaterializedResumeDtoFromCli(c emigo.CliCastable) MaterializedResumeDto {
	data := MaterializedResumeDto{}
