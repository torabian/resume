...
func (x *WorkExperienceDto) Json() string {
	if x != nil {
...
func GetWorkExperienceDtoCliFlags(prefix string) []emigo.CliFlag {
...
func CastWorkExperienceDtoFromCli(c emigo.CliCastable) WorkExperienceDto {
