...
export class ResumeDto {
  ...
  static DefaultTranslations = {
    $title: "ResumeDto",
    $description: 'Plain dto mirroring the "resume" entity\'s own fields.',
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<ResumeDto>;
  ...
  /**
   * Creates an instance of ResumeDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: ResumeDtoType) {
    return new ResumeDto(possibleDtoObject);
  }
  /**
   * Creates an instance of ResumeDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<ResumeDtoType>) {
    return new ResumeDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<ResumeDtoType>,
  ): InstanceType<typeof ResumeDto> {
    return new ResumeDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof ResumeDto> {
    return new ResumeDto(this.toJSON());
  }
}
export abstract class ResumeDtoFactory {
  abstract create(data: unknown): ResumeDto;
}
export type ResumeDtoTranslationKey =
  keyof typeof ResumeDto.DefaultTranslations;
export type ResumeDtoTranslations = Record<ResumeDtoTranslationKey, string>;
/**
 * The base type definition for resumeDto
 **/
