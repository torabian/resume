...
/**
 * Action to communicate with the action projectGet
 */
export type ProjectGetActionOptions = {
  queryKey?: unknown[];
  params: ProjectGetActionPathParameter;
  qs?: URLSearchParams;
};
export type ProjectGetActionQueryOptions = Omit<
  UseQueryOptions<unknown, unknown, GResponse<ProjectDto>, unknown[]>,
  "queryKey"
> &
  ProjectGetActionOptions &
  Partial<{
...
export const useProjectGetActionQuery = (
  options: ProjectGetActionQueryOptions,
) => {
  ...
  const result = useQuery({
    queryKey: [ProjectGetAction.NewUrl(options.params, options?.qs)],
    queryFn: fn,
...
export type ProjectGetActionMutationOptions = Omit<
...
export const useProjectGetAction = (
  options: ProjectGetActionMutationOptions,
) => {
  const globalCtx = useFetchxContext();
  const ctx = options?.ctx ?? globalCtx ?? undefined;
  const [isCompleted, setCompleteState] = useState(false);
 ...
 */
export type ProjectGetActionPathParameter = {
  uniqueId: string;
};
/**
 * ProjectGetAction
...
export class ProjectGetAction {
  ...
  static NewUrl = (
    params: ProjectGetActionPathParameter,
    qs?: URLSearchParams,
  ) => buildUrl(ProjectGetAction.URL, params, qs);
  static Method = "GET";
  static Fetch$ = async (
    params: ProjectGetActionPathParameter,
    qs?: URLSearchParams,
    ...
    return fetchx<GResponse<ProjectDto>, unknown, unknown>(
      overrideUrl ?? ProjectGetAction.NewUrl(params, qs),
      {
        method: ProjectGetAction.Method,
        ...(init || {}),
      },
      ctx,
    );
  ...
  static Fetch = async (
    ...
    const res = await ProjectGetAction.Fetch$(
      params,
      qs,
      ctx,
      init,
