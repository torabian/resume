...
/**
 * Action to communicate with the action certificationGet
 */
export type CertificationGetActionOptions = {
  queryKey?: unknown[];
  params: CertificationGetActionPathParameter;
  qs?: URLSearchParams;
};
export type CertificationGetActionQueryOptions = Omit<
  UseQueryOptions<unknown, unknown, GResponse<CertificationDto>, unknown[]>,
  "queryKey"
> &
  CertificationGetActionOptions &
  Partial<{
...
export const useCertificationGetActionQuery = (
  options: CertificationGetActionQueryOptions,
) => {
  ...
  const fn = () => {
    ...
    return CertificationGetAction.Fetch(
      options.params,
      {
  ...
  const result = useQuery({
    queryKey: [CertificationGetAction.NewUrl(options.params, options?.qs)],
    queryFn: fn,
...
export type CertificationGetActionMutationOptions = Omit<
...
export const useCertificationGetAction = (
  options: CertificationGetActionMutationOptions,
) => {
  const globalCtx = useFetchxContext();
  const ctx = options?.ctx ?? globalCtx ?? undefined;
  const [isCompleted, setCompleteState] = useState(false);
 ...
 */
export type CertificationGetActionPathParameter = {
  uniqueId: string;
};
/**
 * CertificationGetAction
 */
export class CertificationGetAction {
  //
  static URL = "/certification/:uniqueId";
  static NewUrl = (
    params: CertificationGetActionPathParameter,
    qs?: URLSearchParams,
  ) => buildUrl(CertificationGetAction.URL, params, qs);
  static Method = "GET";
  static Fetch$ = async (
    params: CertificationGetActionPathParameter,
    qs?: URLSearchParams,
    ...
    return fetchx<GResponse<CertificationDto>, unknown, unknown>(
      overrideUrl ?? CertificationGetAction.NewUrl(params, qs),
      {
        method: CertificationGetAction.Method,
        ...(init || {}),
      },
      ctx,
    );
  ...
  static Fetch = async (
    ...
    const res = await CertificationGetAction.Fetch$(
      params,
      qs,
      ctx,
      init,
