...
export class SkillOptionalDto {
  ...
  static DefaultTranslations = {
    $title: "SkillOptionalDto",
    $description:
      "Every field of the \"skill\" entity, but optional - used both as Update's partial input and as Browse's response item shape.",
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<SkillOptionalDto>;
  ...
  /**
   * Creates an instance of SkillOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: SkillOptionalDtoType) {
    return new SkillOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of SkillOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<SkillOptionalDtoType>) {
    return new SkillOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<SkillOptionalDtoType>,
  ): InstanceType<typeof SkillOptionalDto> {
    return new SkillOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof SkillOptionalDto> {
    return new SkillOptionalDto(this.toJSON());
  }
}
export abstract class SkillOptionalDtoFactory {
  abstract create(data: unknown): SkillOptionalDto;
}
export type SkillOptionalDtoTranslationKey =
  keyof typeof SkillOptionalDto.DefaultTranslations;
export type SkillOptionalDtoTranslations = Record<
  SkillOptionalDtoTranslationKey,
  string
>;
/**
 * The base type definition for skillOptionalDto
 **/
export type SkillOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace SkillOptionalDtoType {}
