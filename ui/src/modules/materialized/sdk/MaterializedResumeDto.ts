...
/**
 * The base class definition for materializedResumeDto
 **/
export class MaterializedResumeDto {
  /**
   *
   * @type {string}
   **/
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<MaterializedResumeDto>;
  ...
  /**
   * Creates an instance of MaterializedResumeDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: MaterializedResumeDtoType) {
    return new MaterializedResumeDto(possibleDtoObject);
  }
  /**
   * Creates an instance of MaterializedResumeDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<MaterializedResumeDtoType>) {
    return new MaterializedResumeDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<MaterializedResumeDtoType>,
  ): InstanceType<typeof MaterializedResumeDto> {
    return new MaterializedResumeDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof MaterializedResumeDto> {
    return new MaterializedResumeDto(this.toJSON());
  }
}
export abstract class MaterializedResumeDtoFactory {
  abstract create(data: unknown): MaterializedResumeDto;
}
/**
 * The base type definition for materializedResumeDto
 **/
export type MaterializedResumeDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace MaterializedResumeDtoType {}
