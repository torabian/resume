...
// dropdowns. regionalContent no longer carries content/title/languageId itself - each
// is its own regionalContentDefinition row now (see Messaging.emi.yml), so all a
