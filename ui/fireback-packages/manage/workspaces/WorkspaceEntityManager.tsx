...
export const WorkspaceEntityManager = ({ data }: DtoEntity<WorkspaceDto>) => {
  ...
  return (
    <CommonEntityManager
      ...
      // The seeded "root" workspace is a system fixture (RepairTheWorkspaces,
      // WorkspaceActions.go) - WorkspaceUpdateAction rejects modifying it outright,
      // so the form is locked read-only here too rather than letting an admin fill
      // it out only to have Save fail.
