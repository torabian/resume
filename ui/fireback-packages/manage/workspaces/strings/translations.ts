...
export const en = {
  ...
  workspaceTypeHint: "Choose the type which defines this workspace's role. Required.",
...
export const fa = {
  ...
  workspaceType: "نوع فضای کاری",
  workspaceTypeHint: "نوعی را انتخاب کنید که نقش این فضای کاری را مشخص می‌کند. الزامی است.",
...
export const pl = {
  ...
  workspaceTypeHint: "Wybierz typ, który określa rolę tej przestrzeni roboczej. Wymagane.",
