...
// name is complexes.TString now (a locale -> text map, see Abac.emi.yml's own comment on
// the role entity) - the implementation actually returns RoleEntity rows as-is (see
// QueryWorkspaceRolesActionImplementation.go), so this mirrors that shape.
