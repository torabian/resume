...
export class CapabilityDto {
  ...
  /**
   * Display name, as a locale -> text map (e.g. {"en": "Query user", "fa": "مشاهده کاربر"}) - see complexes.TString. Mirrors application.PermissionInfo.Name, which every builtin capability's UniqueId/Name/Description are seeded from (see CapabilityUpsertPermissionFn).
   * @type {TString}
   **/
  #name!: TString;
  /**
  ...
  /**
   * Short explanation of what the capability grants, as a locale -> text map - see the name field's own comment above.
   * @type {TString}
   **/
  #description!: TString;
  /**
