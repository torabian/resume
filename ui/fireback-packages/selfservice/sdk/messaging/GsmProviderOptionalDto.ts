...
export class GsmProviderOptionalDto {
   ...
   * @type {string}
   **/
  #mainSenderNumber?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
   ...
   * @type {any}
   **/
  #type?: any | null | undefined = undefined;
  /**
   *
   * @returns {any}
   **/
   ...
   * @type {string}
   **/
  #invokeUrl?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #invokeBody?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
