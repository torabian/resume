...
/**
 * The base class definition for regionalContentDefinitionDto
 **/
export class RegionalContentDefinitionDto {
  /**
   *
   * @type {string}
   **/
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<RegionalContentDefinitionDto>;
  ...
  /**
   * Creates an instance of RegionalContentDefinitionDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: RegionalContentDefinitionDtoType) {
    return new RegionalContentDefinitionDto(possibleDtoObject);
  }
  /**
   * Creates an instance of RegionalContentDefinitionDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<RegionalContentDefinitionDtoType>) {
    return new RegionalContentDefinitionDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<RegionalContentDefinitionDtoType>,
  ): InstanceType<typeof RegionalContentDefinitionDto> {
    return new RegionalContentDefinitionDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof RegionalContentDefinitionDto> {
    return new RegionalContentDefinitionDto(this.toJSON());
  }
}
export abstract class RegionalContentDefinitionDtoFactory {
  abstract create(data: unknown): RegionalContentDefinitionDto;
}
/**
 * The base type definition for regionalContentDefinitionDto
 **/
export type RegionalContentDefinitionDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace RegionalContentDefinitionDtoType {}
