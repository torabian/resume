import { MJson, PlainTime, TString } from "@fireback/complexes";
...
export class RoleOptionalDto {
  ...
  /**
   * Display name, as a locale -> text map (e.g. {"en": "Root Access", "fa": "دسترسی ریشه"}) - see complexes.TString.
   * @type {TString}
   **/
  #name!: TString;
  /**
   ...
   * @type {MJson}
   **/
  set capabilitiesListId(value: MJson) {
    if (value instanceof MJson) {
      this.#capabilitiesListId = value;
    } else {
      this.#capabilitiesListId = new MJson(value);
    }
  }
  setCapabilitiesListId(value: MJson) {
    this.capabilitiesListId = value;
    return this;
  }
  /**
   ...
   * @type {boolean}
   **/
  #isDeletable?: boolean | null | undefined = undefined;
  /**
   *
   * @returns {boolean}
   **/
   ...
   * @type {boolean}
   **/
  #isUpdatable?: boolean | null | undefined = undefined;
  /**
   *
   * @returns {boolean}
   **/
