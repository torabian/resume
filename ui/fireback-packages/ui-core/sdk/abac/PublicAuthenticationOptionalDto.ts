...
export class PublicAuthenticationOptionalDto {
   ...
   * @type {string}
   **/
  #totpSecret?: string | null | undefined = undefined;
  /**
   * If the application requires totp dual factor upon account creation, we create a secret here and pass the link
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #totpLink?: string | null | undefined = undefined;
  /**
   * The url which will be converted into QR code on client side to scan
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #passportId?: string | null | undefined = undefined;
  /**
   * The unique-id of the passport this record belongs to.
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #sessionSecret?: string | null | undefined = undefined;
  /**
   * This is a long hash generated and will be used to authenticate user after he confirmed the otp to finish the signup process and add more information before creating an account
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #passportValue?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
   ...
   * @type {boolean}
   **/
  #isInCreationProcess?: boolean | null | undefined = undefined;
  /**
   *
   * @returns {boolean}
   **/
   ...
   * @type {number}
   **/
  #blockedUntil?: number | null | undefined = undefined;
  /**
   *
   * @returns {number}
   **/
   ...
   * @type {string}
   **/
  #otp?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #recoveryAbsoluteUrl?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
