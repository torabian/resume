import { PlainTime, XDate } from "@fireback/complexes";
...
export class UserOptionalDto {
   ...
   * @type {string}
   **/
  #photo?: string | null | undefined = undefined;
  /**
   *
   * @returns {string}
   **/
   ...
   * @type {number}
   **/
  #gender?: number | null | undefined = undefined;
  /**
   *
   * @returns {number}
   **/
  ...
  set birthDate(value: XDate) {
    if (value instanceof XDate) {
      ...
      this.#birthDate = new XDate(value);
    }
  }
   ...
   * @type {string}
   **/
  #lastIpAddress?: string | null | undefined = undefined;
  /**
   * User last connecting ip address
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #jobTitle?: string | null | undefined = undefined;
  /**
   * The user's job title/role, e.g. "Support Engineer".
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #company?: string | null | undefined = undefined;
  /**
   * The company or organization the user is associated with.
   * @returns {string}
   **/
  ...
  static PrimaryAddress = class PrimaryAddress {
     ...
     * @type {string}
     **/
    #addressLine1?: string | null | undefined = undefined;
    /**
     * Street address, building number
     * @returns {string}
     **/
     ...
     * @type {string}
     **/
    #addressLine2?: string | null | undefined = undefined;
    /**
     * Apartment, suite, floor (optional)
     * @returns {string}
     **/
     ...
     * @type {string}
     **/
    #stateOrProvince?: string | null | undefined = undefined;
    /**
     * State, region, or province
     * @returns {string}
     **/
     ...
     * @type {string}
     **/
    #countryCode?: string | null | undefined = undefined;
    /**
     * ISO 3166-1 alpha-2 (e.g., "US", "DE")
     * @returns {string}
     **/
