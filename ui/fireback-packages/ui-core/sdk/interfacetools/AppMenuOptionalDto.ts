...
export class AppMenuOptionalDto {
   ...
   * @type {string}
   **/
  #href?: string | null | undefined = undefined;
  /**
   * Location that will be navigated in case of click or selection on ui
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #activeMatcher?: string | null | undefined = undefined;
  /**
   * Custom window location url matchers, for inner screens.
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #capabilityId?: string | null | undefined = undefined;
  /**
   * The unique-id of the capability which is required for the menu to be visible.
   * @returns {string}
   **/
