...
/**
 * Action to communicate with the action regionalContentDefinitionGet
 */
export type RegionalContentDefinitionGetActionOptions = {
  queryKey?: unknown[];
  params: RegionalContentDefinitionGetActionPathParameter;
  qs?: URLSearchParams;
};
export type RegionalContentDefinitionGetActionQueryOptions = Omit<
  UseQueryOptions<
    unknown,
    unknown,
  ...
  "queryKey"
> &
  RegionalContentDefinitionGetActionOptions &
  Partial<{
...
export const useRegionalContentDefinitionGetActionQuery = (
  options: RegionalContentDefinitionGetActionQueryOptions,
) => {
  ...
  const fn = () => {
    ...
    return RegionalContentDefinitionGetAction.Fetch(
      options.params,
      {
  ...
  const result = useQuery({
    queryKey: [
      RegionalContentDefinitionGetAction.NewUrl(options.params, options?.qs),
    ],
    queryFn: fn,
...
export type RegionalContentDefinitionGetActionMutationOptions = Omit<
...
export const useRegionalContentDefinitionGetAction = (
  options: RegionalContentDefinitionGetActionMutationOptions,
) => {
  const globalCtx = useFetchxContext();
  const ctx = options?.ctx ?? globalCtx ?? undefined;
  const [isCompleted, setCompleteState] = useState(false);
...
/**
 * Path parameters for RegionalContentDefinitionGetAction
 */
export type RegionalContentDefinitionGetActionPathParameter = {
  uniqueId: string;
};
/**
 * RegionalContentDefinitionGetAction
 */
export class RegionalContentDefinitionGetAction {
  //
  static URL = "/regionalContentDefinition/:uniqueId";
  static NewUrl = (
    params: RegionalContentDefinitionGetActionPathParameter,
    qs?: URLSearchParams,
  ) => buildUrl(RegionalContentDefinitionGetAction.URL, params, qs);
  static Method = "GET";
  static Fetch$ = async (
    params: RegionalContentDefinitionGetActionPathParameter,
    qs?: URLSearchParams,
    ...
    return fetchx<GResponse<RegionalContentDefinitionDto>, unknown, unknown>(
      overrideUrl ?? RegionalContentDefinitionGetAction.NewUrl(params, qs),
      {
        method: RegionalContentDefinitionGetAction.Method,
        ...(init || {}),
      },
      ctx,
    );
  ...
  static Fetch = async (
    ...
    const res = await RegionalContentDefinitionGetAction.Fetch$(
      params,
      qs,
      ctx,
      init,
  ...
  static Definition = {
    name: "regionalContentDefinitionGet",
    cliName: "get",
    cliShort: "g",
    url: "/regionalContentDefinition/:uniqueId string",
    method: "get",
    description:
      'Looks up a single "regionalContentDefinition" row by uniqueId.',
    out: {
      envelope: "GResponse",
