...
import type { FetchxContext } from "@fireback/js-remote-ctx/common/fetchx";
...
export interface SessionGateProps {
   ...
   */
  checkSession: (ctx: FetchxContext) => Promise<unknown>;
  children: ReactNode;
...
export function SessionGate({
  ...
  const fetchxCtx = useFetchxContext();
