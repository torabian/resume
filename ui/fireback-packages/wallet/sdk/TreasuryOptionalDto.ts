...
/**
 * The base class definition for treasuryOptionalDto
 **/
export class TreasuryOptionalDto {
  /**
   *
   * @type {string}
   **/
  ...
  applyFromObject(data = {}) {
    const d = data as Partial<TreasuryOptionalDto>;
  ...
  /**
   * Creates an instance of TreasuryOptionalDto, and possibleDtoObject
   * needs to satisfy the type requirement fully, otherwise typescript compile would
   * be complaining.
   **/
  static from(possibleDtoObject: TreasuryOptionalDtoType) {
    return new TreasuryOptionalDto(possibleDtoObject);
  }
  /**
   * Creates an instance of TreasuryOptionalDto, and partialDtoObject
   * needs to satisfy the type, but partially, and rest of the content would
   * be constructed according to data types and nullability.
   **/
  static with(partialDtoObject: PartialDeep<TreasuryOptionalDtoType>) {
    return new TreasuryOptionalDto(partialDtoObject);
  }
  copyWith(
    partial: PartialDeep<TreasuryOptionalDtoType>,
  ): InstanceType<typeof TreasuryOptionalDto> {
    return new TreasuryOptionalDto({ ...this.toJSON(), ...partial });
  }
  clone(): InstanceType<typeof TreasuryOptionalDto> {
    return new TreasuryOptionalDto(this.toJSON());
  }
}
export abstract class TreasuryOptionalDtoFactory {
  abstract create(data: unknown): TreasuryOptionalDto;
}
/**
 * The base type definition for treasuryOptionalDto
 **/
export type TreasuryOptionalDtoType = {
  /**
   *
   * @type {string}
   **/
...
export namespace TreasuryOptionalDtoType {}
