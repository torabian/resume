...
export class WalletPaymentAttemptOptionalDto {
   ...
   * @type {string}
   **/
  #purpose?: string | null | undefined = "topup";
  /**
   * What this attempt is for.
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #gatewayReference?: string | null | undefined = undefined;
  /**
   * The gateway's own id for this attempt (e.g. a PaymentIntent id or a transaction hash), once known. Indexed for webhook lookups.
   * @returns {string}
   **/
   ...
   * @type {string}
   **/
  #failureReason?: string | null | undefined = undefined;
  /**
   * Human-readable reason, populated when status is "failed".
   * @returns {string}
   **/
   ...
   * @type {MJson}
   **/
  set rawRequest(value: MJson) {
    if (value instanceof MJson) {
      this.#rawRequest = value;
    } else {
      this.#rawRequest = new MJson(value);
    }
  }
  setRawRequest(value: MJson) {
    this.rawRequest = value;
    return this;
  }
  /**
   ...
   * @type {MJson}
   **/
  set rawResponse(value: MJson) {
    if (value instanceof MJson) {
      this.#rawResponse = value;
    } else {
      this.#rawResponse = new MJson(value);
    }
  }
  setRawResponse(value: MJson) {
    this.rawResponse = value;
    return this;
  }
  /**
  ...
  set expiresAt(value: XDate) {
    if (value instanceof XDate) {
      ...
      this.#expiresAt = new XDate(value);
    }
  }
  ...
  set completedAt(value: XDate) {
    if (value instanceof XDate) {
      ...
      this.#completedAt = new XDate(value);
    }
  }
   ...
   * @type {string}
   **/
  #returnUrl?: string | null | undefined = undefined;
  /**
   * Where to send the caller's browser back to once a redirect-based gateway (e.g. Przelewy24, ZarinPal) completes the payment. Not needed by gateways that never redirect the browser (e.g. Stripe's client-secret confirmation flow).
   * @returns {string}
   **/
